...
%define SMP_TRAMPOLINE_GDT_PTR 0x1000 + 0x10
...
.LoopPageTable:
    ...
    ;lgdt [SMP_TRAMPOLINE_GDT_PTR]                ; Load GDT.Pointer defined below.
...
LongMode:
    ...
    ;jmp Main.Long                     ; You should replace this jump to wherever you want to jump 
